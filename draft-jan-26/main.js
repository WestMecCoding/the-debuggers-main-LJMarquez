...
let products = [
  ...
  },
  {
    ...
    color: "#742D00",
    text_color: "white",
    desc: "French fries are a popular side dish made from potatoes, typically cut into thin strips and deep-fried until golden brown and crispy. They originated in Belgium, not France, and gained worldwide popularity. The potatoes are usually first soaked in water to remove excess starch, ensuring a crispier texture when fried. Commonly seasoned with salt, they can be served with various condiments such as ketchup, mayonnaise, or vinegar. Despite their name, French fries are enjoyed globally and are a staple in fast-food culture. Sold for only $870.00  (Taxes included)",
  },
  {
